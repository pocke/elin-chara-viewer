export const resources = {
  ja: {
    common: {
      ...
      history: '変更履歴',
      historyShowRaw: '生データの変更も表示',
      historyUnavailableYet: 'このキャラの変更履歴はまだ用意されていません',
      historyLoadFailed: '変更履歴を読み込めませんでした',
      historyChangeCount: '変更: {{count}} 件',
      historyViewing: '表示中のバージョン',
      historyOrigin: '記録の開始',
      historyAdded: '追加',
      historyRemoved: '削除',
      historyVariantAdded: '変種の登場',
      historyVariantRemoved: '変種の消滅',
      historyUnavailable: '算出不能',
      historyRawChanges: '生データの変更',
      historyReferenceSwapped: '参照先の入れ替えによる差分',
      historyNoValue: 'なし',
      historyGeneSlotBase: '基礎値',
      historyPotential: 'ベース潜在',
      rawData: '生データ',
    ...
    advancedSearch: {
      ...
      notEmpty: '空でない',
      // カテゴリ
      categoryKeyInfo: '主要情報',
      categoryStats: 'ステータス',
      categoryAttributes: '主能力',
      categorySkills: 'スキル',
  ...
  en: {
    common: {
      ...
      abilities: 'Abilities',
      skills: 'Skills',
      skillsWithPotential: 'Skills (Base Potential)',
      skillsGeneral: 'General Skills',
      skillsCraft: 'Craft Skills',
      skillsCombat: 'Combat Skills',
      skillsWeapon: 'Weapon Proficiency',
      range: 'Range',
      geneSlot: 'Gene Slot',
      geneSlotShort: 'Gene',
      ...
      historyShowRaw: 'Also show raw data changes',
      historyUnavailableYet:
        'No change history has been built for this character yet',
      historyLoadFailed: 'Failed to load the change history',
      historyChangeCount: 'Changes: {{count}}',
      historyViewing: 'Version you are viewing',
      historyOrigin: 'Record starts',
      historyAdded: 'Added',
      historyRemoved: 'Removed',
      historyVariantAdded: 'Variant appeared',
      historyVariantRemoved: 'Variant gone',
      historyUnavailable: 'Cannot be computed',
      historyRawChanges: 'Raw data changes',
      historyReferenceSwapped: 'From pointing at a different row',
      historyNoValue: 'none',
      historyGeneSlotBase: 'base',
      historyPotential: 'Base Potential',
      rawData: 'Raw Data',
