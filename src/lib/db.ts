...
import charasContent from '../../db/EA 23.187/charas.csv';
import elementsContent from '../../db/EA 23.187/elements.csv';
import racesContent from '../../db/EA 23.187/races.csv';
import jobsContent from '../../db/EA 23.187/jobs.csv';
import tacticsContent from '../../db/EA 23.187/tactics.csv';
