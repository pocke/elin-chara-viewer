...
import nightlyCharasContent from '../../db/EA 23.284/charas.csv';
import nightlyElementsContent from '../../db/EA 23.284/elements.csv';
import nightlyRacesContent from '../../db/EA 23.284/races.csv';
import nightlyJobsContent from '../../db/EA 23.284/jobs.csv';
import nightlyTacticsContent from '../../db/EA 23.284/tactics.csv';
