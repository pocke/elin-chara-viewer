...
import nightlyCharasContent from '../../db/EA 23.269/charas.csv';
import nightlyElementsContent from '../../db/EA 23.269/elements.csv';
import nightlyRacesContent from '../../db/EA 23.269/races.csv';
import nightlyJobsContent from '../../db/EA 23.269/jobs.csv';
import nightlyTacticsContent from '../../db/EA 23.269/tactics.csv';
