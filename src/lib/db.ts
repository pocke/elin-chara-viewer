...
import charasContent from '../../db/EA 23.188 Patch 2/charas.csv';
import elementsContent from '../../db/EA 23.188 Patch 2/elements.csv';
import racesContent from '../../db/EA 23.188 Patch 2/races.csv';
import jobsContent from '../../db/EA 23.188 Patch 2/jobs.csv';
import tacticsContent from '../../db/EA 23.188 Patch 2/tactics.csv';
