...
import nightlyCharasContent from '../../db/EA 23.253/charas.csv';
import nightlyElementsContent from '../../db/EA 23.253/elements.csv';
import nightlyRacesContent from '../../db/EA 23.253/races.csv';
import nightlyJobsContent from '../../db/EA 23.253/jobs.csv';
import nightlyTacticsContent from '../../db/EA 23.253/tactics.csv';
