...
import charasContent from '../../db/EA 23.222/charas.csv';
import elementsContent from '../../db/EA 23.222/elements.csv';
import racesContent from '../../db/EA 23.222/races.csv';
import jobsContent from '../../db/EA 23.222/jobs.csv';
import tacticsContent from '../../db/EA 23.222/tactics.csv';
