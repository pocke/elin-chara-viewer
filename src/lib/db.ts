...
import nightlyCharasContent from '../../db/EA 23.264/charas.csv';
import nightlyElementsContent from '../../db/EA 23.264/elements.csv';
import nightlyRacesContent from '../../db/EA 23.264/races.csv';
import nightlyJobsContent from '../../db/EA 23.264/jobs.csv';
import nightlyTacticsContent from '../../db/EA 23.264/tactics.csv';
