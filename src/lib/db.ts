...
import nightlyCharasContent from '../../db/EA 23.296/charas.csv';
import nightlyElementsContent from '../../db/EA 23.296/elements.csv';
import nightlyRacesContent from '../../db/EA 23.296/races.csv';
import nightlyJobsContent from '../../db/EA 23.296/jobs.csv';
import nightlyTacticsContent from '../../db/EA 23.296/tactics.csv';
