...
import nightlyCharasContent from '../../db/EA 23.327/charas.csv';
import nightlyElementsContent from '../../db/EA 23.327/elements.csv';
import nightlyRacesContent from '../../db/EA 23.327/races.csv';
import nightlyJobsContent from '../../db/EA 23.327/jobs.csv';
import nightlyTacticsContent from '../../db/EA 23.327/tactics.csv';
