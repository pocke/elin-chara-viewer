...
import nightlyCharasContent from '../../db/EA 23.268/charas.csv';
import nightlyElementsContent from '../../db/EA 23.268/elements.csv';
import nightlyRacesContent from '../../db/EA 23.268/races.csv';
import nightlyJobsContent from '../../db/EA 23.268/jobs.csv';
import nightlyTacticsContent from '../../db/EA 23.268/tactics.csv';
