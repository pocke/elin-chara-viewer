...
import nightlyCharasContent from '../../db/EA 23.243/charas.csv';
import nightlyElementsContent from '../../db/EA 23.243/elements.csv';
import nightlyRacesContent from '../../db/EA 23.243/races.csv';
import nightlyJobsContent from '../../db/EA 23.243/jobs.csv';
import nightlyTacticsContent from '../../db/EA 23.243/tactics.csv';
