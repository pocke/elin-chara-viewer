...
import nightlyCharasContent from '../../db/EA 23.244/charas.csv';
import nightlyElementsContent from '../../db/EA 23.244/elements.csv';
import nightlyRacesContent from '../../db/EA 23.244/races.csv';
import nightlyJobsContent from '../../db/EA 23.244/jobs.csv';
import nightlyTacticsContent from '../../db/EA 23.244/tactics.csv';
