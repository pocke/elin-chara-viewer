...
import nightlyCharasContent from '../../db/EA 23.275/charas.csv';
import nightlyElementsContent from '../../db/EA 23.275/elements.csv';
import nightlyRacesContent from '../../db/EA 23.275/races.csv';
import nightlyJobsContent from '../../db/EA 23.275/jobs.csv';
import nightlyTacticsContent from '../../db/EA 23.275/tactics.csv';
