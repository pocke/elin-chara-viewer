...
import nightlyCharasContent from '../../db/EA 23.249/charas.csv';
import nightlyElementsContent from '../../db/EA 23.249/elements.csv';
import nightlyRacesContent from '../../db/EA 23.249/races.csv';
import nightlyJobsContent from '../../db/EA 23.249/jobs.csv';
import nightlyTacticsContent from '../../db/EA 23.249/tactics.csv';
