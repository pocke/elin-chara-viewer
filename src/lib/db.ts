...
import nightlyCharasContent from '../../db/EA 23.304/charas.csv';
import nightlyElementsContent from '../../db/EA 23.304/elements.csv';
import nightlyRacesContent from '../../db/EA 23.304/races.csv';
import nightlyJobsContent from '../../db/EA 23.304/jobs.csv';
import nightlyTacticsContent from '../../db/EA 23.304/tactics.csv';
