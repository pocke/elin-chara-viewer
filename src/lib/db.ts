...
import nightlyCharasContent from '../../db/EA 23.300/charas.csv';
import nightlyElementsContent from '../../db/EA 23.300/elements.csv';
import nightlyRacesContent from '../../db/EA 23.300/races.csv';
import nightlyJobsContent from '../../db/EA 23.300/jobs.csv';
import nightlyTacticsContent from '../../db/EA 23.300/tactics.csv';
