...
import nightlyCharasContent from '../../db/EA 23.301/charas.csv';
import nightlyElementsContent from '../../db/EA 23.301/elements.csv';
import nightlyRacesContent from '../../db/EA 23.301/races.csv';
import nightlyJobsContent from '../../db/EA 23.301/jobs.csv';
import nightlyTacticsContent from '../../db/EA 23.301/tactics.csv';
