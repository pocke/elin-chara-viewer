...
import nightlyCharasContent from '../../db/EA 23.262/charas.csv';
import nightlyElementsContent from '../../db/EA 23.262/elements.csv';
import nightlyRacesContent from '../../db/EA 23.262/races.csv';
import nightlyJobsContent from '../../db/EA 23.262/jobs.csv';
import nightlyTacticsContent from '../../db/EA 23.262/tactics.csv';
