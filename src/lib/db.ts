...
import nightlyCharasContent from '../../db/EA 23.254/charas.csv';
import nightlyElementsContent from '../../db/EA 23.254/elements.csv';
import nightlyRacesContent from '../../db/EA 23.254/races.csv';
import nightlyJobsContent from '../../db/EA 23.254/jobs.csv';
import nightlyTacticsContent from '../../db/EA 23.254/tactics.csv';
