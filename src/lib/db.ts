...
import nightlyCharasContent from '../../db/EA 23.242/charas.csv';
import nightlyElementsContent from '../../db/EA 23.242/elements.csv';
import nightlyRacesContent from '../../db/EA 23.242/races.csv';
import nightlyJobsContent from '../../db/EA 23.242/jobs.csv';
import nightlyTacticsContent from '../../db/EA 23.242/tactics.csv';
