...
import nightlyCharasContent from '../../db/EA 23.272/charas.csv';
import nightlyElementsContent from '../../db/EA 23.272/elements.csv';
import nightlyRacesContent from '../../db/EA 23.272/races.csv';
import nightlyJobsContent from '../../db/EA 23.272/jobs.csv';
import nightlyTacticsContent from '../../db/EA 23.272/tactics.csv';
