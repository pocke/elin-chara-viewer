...
import nightlyCharasContent from '../../db/EA 23.303/charas.csv';
import nightlyElementsContent from '../../db/EA 23.303/elements.csv';
import nightlyRacesContent from '../../db/EA 23.303/races.csv';
import nightlyJobsContent from '../../db/EA 23.303/jobs.csv';
import nightlyTacticsContent from '../../db/EA 23.303/tactics.csv';
