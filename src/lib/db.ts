...
import nightlyCharasContent from '../../db/EA 23.290/charas.csv';
import nightlyElementsContent from '../../db/EA 23.290/elements.csv';
import nightlyRacesContent from '../../db/EA 23.290/races.csv';
import nightlyJobsContent from '../../db/EA 23.290/jobs.csv';
import nightlyTacticsContent from '../../db/EA 23.290/tactics.csv';
