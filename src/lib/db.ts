...
import nightlyCharasContent from '../../db/EA 23.289/charas.csv';
import nightlyElementsContent from '../../db/EA 23.289/elements.csv';
import nightlyRacesContent from '../../db/EA 23.289/races.csv';
import nightlyJobsContent from '../../db/EA 23.289/jobs.csv';
import nightlyTacticsContent from '../../db/EA 23.289/tactics.csv';
