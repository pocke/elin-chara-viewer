...
import nightlyCharasContent from '../../db/EA 23.245/charas.csv';
import nightlyElementsContent from '../../db/EA 23.245/elements.csv';
import nightlyRacesContent from '../../db/EA 23.245/races.csv';
import nightlyJobsContent from '../../db/EA 23.245/jobs.csv';
import nightlyTacticsContent from '../../db/EA 23.245/tactics.csv';
