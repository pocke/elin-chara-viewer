...
import nightlyCharasContent from '../../db/EA 23.256/charas.csv';
import nightlyElementsContent from '../../db/EA 23.256/elements.csv';
import nightlyRacesContent from '../../db/EA 23.256/races.csv';
import nightlyJobsContent from '../../db/EA 23.256/jobs.csv';
import nightlyTacticsContent from '../../db/EA 23.256/tactics.csv';
