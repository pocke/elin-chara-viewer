...
import nightlyCharasContent from '../../db/EA 23.326/charas.csv';
import nightlyElementsContent from '../../db/EA 23.326/elements.csv';
import nightlyRacesContent from '../../db/EA 23.326/races.csv';
import nightlyJobsContent from '../../db/EA 23.326/jobs.csv';
import nightlyTacticsContent from '../../db/EA 23.326/tactics.csv';
