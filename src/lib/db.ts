...
import charasContent from '../../db/EA 23.209 Patch 1/charas.csv';
import elementsContent from '../../db/EA 23.209 Patch 1/elements.csv';
import racesContent from '../../db/EA 23.209 Patch 1/races.csv';
import jobsContent from '../../db/EA 23.209 Patch 1/jobs.csv';
import tacticsContent from '../../db/EA 23.209 Patch 1/tactics.csv';
