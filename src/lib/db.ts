...
import nightlyCharasContent from '../../db/EA 23.313/charas.csv';
import nightlyElementsContent from '../../db/EA 23.313/elements.csv';
import nightlyRacesContent from '../../db/EA 23.313/races.csv';
import nightlyJobsContent from '../../db/EA 23.313/jobs.csv';
import nightlyTacticsContent from '../../db/EA 23.313/tactics.csv';
