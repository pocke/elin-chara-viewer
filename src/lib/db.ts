...
import nightlyCharasContent from '../../db/EA 23.312 Patch 3/charas.csv';
import nightlyElementsContent from '../../db/EA 23.312 Patch 3/elements.csv';
import nightlyRacesContent from '../../db/EA 23.312 Patch 3/races.csv';
import nightlyJobsContent from '../../db/EA 23.312 Patch 3/jobs.csv';
import nightlyTacticsContent from '../../db/EA 23.312 Patch 3/tactics.csv';
