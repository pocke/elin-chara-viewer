...
import nightlyCharasContent from '../../db/EA 23.248/charas.csv';
import nightlyElementsContent from '../../db/EA 23.248/elements.csv';
import nightlyRacesContent from '../../db/EA 23.248/races.csv';
import nightlyJobsContent from '../../db/EA 23.248/jobs.csv';
import nightlyTacticsContent from '../../db/EA 23.248/tactics.csv';
