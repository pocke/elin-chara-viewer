...
import nightlyCharasContent from '../../db/EA 23.263 Patch 2/charas.csv';
import nightlyElementsContent from '../../db/EA 23.263 Patch 2/elements.csv';
import nightlyRacesContent from '../../db/EA 23.263 Patch 2/races.csv';
import nightlyJobsContent from '../../db/EA 23.263 Patch 2/jobs.csv';
import nightlyTacticsContent from '../../db/EA 23.263 Patch 2/tactics.csv';
