...
import nightlyCharasContent from '../../db/EA 23.302/charas.csv';
import nightlyElementsContent from '../../db/EA 23.302/elements.csv';
import nightlyRacesContent from '../../db/EA 23.302/races.csv';
import nightlyJobsContent from '../../db/EA 23.302/jobs.csv';
import nightlyTacticsContent from '../../db/EA 23.302/tactics.csv';
