...
import nightlyCharasContent from '../../db/EA 23.315/charas.csv';
import nightlyElementsContent from '../../db/EA 23.315/elements.csv';
import nightlyRacesContent from '../../db/EA 23.315/races.csv';
import nightlyJobsContent from '../../db/EA 23.315/jobs.csv';
import nightlyTacticsContent from '../../db/EA 23.315/tactics.csv';
