...
import nightlyCharasContent from '../../db/EA 23.345/charas.csv';
import nightlyElementsContent from '../../db/EA 23.345/elements.csv';
import nightlyRacesContent from '../../db/EA 23.345/races.csv';
import nightlyJobsContent from '../../db/EA 23.345/jobs.csv';
import nightlyTacticsContent from '../../db/EA 23.345/tactics.csv';
