...
import nightlyCharasContent from '../../db/EA 23.349/charas.csv';
import nightlyElementsContent from '../../db/EA 23.349/elements.csv';
import nightlyRacesContent from '../../db/EA 23.349/races.csv';
import nightlyJobsContent from '../../db/EA 23.349/jobs.csv';
import nightlyTacticsContent from '../../db/EA 23.349/tactics.csv';
