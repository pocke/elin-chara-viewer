...
import nightlyCharasContent from '../../db/EA 23.333/charas.csv';
import nightlyElementsContent from '../../db/EA 23.333/elements.csv';
import nightlyRacesContent from '../../db/EA 23.333/races.csv';
import nightlyJobsContent from '../../db/EA 23.333/jobs.csv';
import nightlyTacticsContent from '../../db/EA 23.333/tactics.csv';
