...
import nightlyCharasContent from '../../db/EA 23.342/charas.csv';
import nightlyElementsContent from '../../db/EA 23.342/elements.csv';
import nightlyRacesContent from '../../db/EA 23.342/races.csv';
import nightlyJobsContent from '../../db/EA 23.342/jobs.csv';
import nightlyTacticsContent from '../../db/EA 23.342/tactics.csv';
