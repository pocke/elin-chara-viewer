...
import nightlyCharasContent from '../../db/EA 23.343/charas.csv';
import nightlyElementsContent from '../../db/EA 23.343/elements.csv';
import nightlyRacesContent from '../../db/EA 23.343/races.csv';
import nightlyJobsContent from '../../db/EA 23.343/jobs.csv';
import nightlyTacticsContent from '../../db/EA 23.343/tactics.csv';
