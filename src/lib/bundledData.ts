...
import nightlyCharasContent from '../../db/EA 23.347/charas.csv';
import nightlyElementsContent from '../../db/EA 23.347/elements.csv';
import nightlyRacesContent from '../../db/EA 23.347/races.csv';
import nightlyJobsContent from '../../db/EA 23.347/jobs.csv';
import nightlyTacticsContent from '../../db/EA 23.347/tactics.csv';
