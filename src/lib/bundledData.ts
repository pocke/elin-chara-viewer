...
import nightlyCharasContent from '../../db/EA 23.335/charas.csv';
import nightlyElementsContent from '../../db/EA 23.335/elements.csv';
import nightlyRacesContent from '../../db/EA 23.335/races.csv';
import nightlyJobsContent from '../../db/EA 23.335/jobs.csv';
import nightlyTacticsContent from '../../db/EA 23.335/tactics.csv';
