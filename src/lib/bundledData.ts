...
import nightlyCharasContent from '../../db/EA 23.348/charas.csv';
import nightlyElementsContent from '../../db/EA 23.348/elements.csv';
import nightlyRacesContent from '../../db/EA 23.348/races.csv';
import nightlyJobsContent from '../../db/EA 23.348/jobs.csv';
import nightlyTacticsContent from '../../db/EA 23.348/tactics.csv';
