...
import nightlyCharasContent from '../../db/EA 23.339/charas.csv';
import nightlyElementsContent from '../../db/EA 23.339/elements.csv';
import nightlyRacesContent from '../../db/EA 23.339/races.csv';
import nightlyJobsContent from '../../db/EA 23.339/jobs.csv';
import nightlyTacticsContent from '../../db/EA 23.339/tactics.csv';
