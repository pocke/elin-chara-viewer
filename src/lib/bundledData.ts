...
import nightlyCharasContent from '../../db/EA 23.344/charas.csv';
import nightlyElementsContent from '../../db/EA 23.344/elements.csv';
import nightlyRacesContent from '../../db/EA 23.344/races.csv';
import nightlyJobsContent from '../../db/EA 23.344/jobs.csv';
import nightlyTacticsContent from '../../db/EA 23.344/tactics.csv';
