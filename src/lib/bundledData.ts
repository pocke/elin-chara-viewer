...
import nightlyCharasContent from '../../db/EA 23.336/charas.csv';
import nightlyElementsContent from '../../db/EA 23.336/elements.csv';
import nightlyRacesContent from '../../db/EA 23.336/races.csv';
import nightlyJobsContent from '../../db/EA 23.336/jobs.csv';
import nightlyTacticsContent from '../../db/EA 23.336/tactics.csv';
