...
import nightlyCharasContent from '../../db/EA 23.343 Patch 5/charas.csv';
import nightlyElementsContent from '../../db/EA 23.343 Patch 5/elements.csv';
import nightlyRacesContent from '../../db/EA 23.343 Patch 5/races.csv';
import nightlyJobsContent from '../../db/EA 23.343 Patch 5/jobs.csv';
import nightlyTacticsContent from '../../db/EA 23.343 Patch 5/tactics.csv';
