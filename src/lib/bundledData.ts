...
import nightlyCharasContent from '../../db/EA 23.331/charas.csv';
import nightlyElementsContent from '../../db/EA 23.331/elements.csv';
import nightlyRacesContent from '../../db/EA 23.331/races.csv';
import nightlyJobsContent from '../../db/EA 23.331/jobs.csv';
import nightlyTacticsContent from '../../db/EA 23.331/tactics.csv';
