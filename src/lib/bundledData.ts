...
import nightlyCharasContent from '../../db/EA 23.346/charas.csv';
import nightlyElementsContent from '../../db/EA 23.346/elements.csv';
import nightlyRacesContent from '../../db/EA 23.346/races.csv';
import nightlyJobsContent from '../../db/EA 23.346/jobs.csv';
import nightlyTacticsContent from '../../db/EA 23.346/tactics.csv';
