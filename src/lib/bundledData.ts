...
import nightlyCharasContent from '../../db/EA 23.340/charas.csv';
import nightlyElementsContent from '../../db/EA 23.340/elements.csv';
import nightlyRacesContent from '../../db/EA 23.340/races.csv';
import nightlyJobsContent from '../../db/EA 23.340/jobs.csv';
import nightlyTacticsContent from '../../db/EA 23.340/tactics.csv';
