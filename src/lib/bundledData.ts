...
import nightlyCharasContent from '../../db/EA 23.338/charas.csv';
import nightlyElementsContent from '../../db/EA 23.338/elements.csv';
import nightlyRacesContent from '../../db/EA 23.338/races.csv';
import nightlyJobsContent from '../../db/EA 23.338/jobs.csv';
import nightlyTacticsContent from '../../db/EA 23.338/tactics.csv';
