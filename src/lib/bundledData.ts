...
import nightlyCharasContent from '../../db/EA 23.330/charas.csv';
import nightlyElementsContent from '../../db/EA 23.330/elements.csv';
import nightlyRacesContent from '../../db/EA 23.330/races.csv';
import nightlyJobsContent from '../../db/EA 23.330/jobs.csv';
import nightlyTacticsContent from '../../db/EA 23.330/tactics.csv';
