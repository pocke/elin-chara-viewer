...
import nightlyCharasContent from '../../db/EA 23.337/charas.csv';
import nightlyElementsContent from '../../db/EA 23.337/elements.csv';
import nightlyRacesContent from '../../db/EA 23.337/races.csv';
import nightlyJobsContent from '../../db/EA 23.337/jobs.csv';
import nightlyTacticsContent from '../../db/EA 23.337/tactics.csv';
