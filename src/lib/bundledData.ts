...
import nightlyCharasContent from '../../db/EA 23.332/charas.csv';
import nightlyElementsContent from '../../db/EA 23.332/elements.csv';
import nightlyRacesContent from '../../db/EA 23.332/races.csv';
import nightlyJobsContent from '../../db/EA 23.332/jobs.csv';
import nightlyTacticsContent from '../../db/EA 23.332/tactics.csv';
