...
import nightlyCharasContent from '../../db/EA 23.348 Patch 1/charas.csv';
import nightlyElementsContent from '../../db/EA 23.348 Patch 1/elements.csv';
import nightlyRacesContent from '../../db/EA 23.348 Patch 1/races.csv';
import nightlyJobsContent from '../../db/EA 23.348 Patch 1/jobs.csv';
import nightlyTacticsContent from '../../db/EA 23.348 Patch 1/tactics.csv';
